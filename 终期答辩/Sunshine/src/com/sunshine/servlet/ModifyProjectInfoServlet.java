...
public class ModifyProjectInfoServlet extends HttpServlet {
...
//					System.out.println(path);
			...
			dao.update(id, title, time, launcherId, favorite, coverImage,
					detailsPage);
			out
					.print("<script>alert('修改项目成功');location = 'dashboard.jsp';</script>");
