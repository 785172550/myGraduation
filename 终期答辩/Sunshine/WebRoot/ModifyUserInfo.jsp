					...
					<div id="contentwrapper" class="contentwrapper">
						<div class="two_third last profile_wrapper">
							<div id="profile" class="subcontent">
								<form action="ModifyUserInfoServlet?id=${user.id}&username=${user.username}" method="post">
									<h4><b>您要修改的用户账号为：<i>${user.username}</i></b></h4>
								...
								<br>
									...
									<br>
									<br>
									<input type="submit" value="确认修改" style="width:200px;height=211px"/>
									</center>
								</form>
							</div>
						</div>
