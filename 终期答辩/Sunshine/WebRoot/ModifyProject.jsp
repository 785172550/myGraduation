							...
							<c:forEach items="${list}" var="u">
								<tr class="gradeX">
									...
									管理员
										...
										<c:if test="${u.launcher_id=='1'}">
									金融
									</c:if>
										<c:if test="${u.launcher_id=='2'}">
									电子商务
									</c:if>
										<c:if test="${u.launcher_id=='3'}">
									房地产
									</c:if>
										<c:if test="${u.launcher_id=='4'}">
									餐饮
									</c:if>
										<c:if test="${u.launcher_id=='5'}">
									创业
									</c:if>
									</td>
									<td class="date">
									...
									<td>
										<a href="ModifyProjectServlet?id=${u.id }">修改</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
