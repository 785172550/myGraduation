...
//                c.moveToFirst();
                ...
                cover_image_uri = PhotoUtil.getSmallBitmap(uri.getPath(), 360, 480);
...
//                Cursor c = cr.query(uri, null, null, null, null);
//                c.moveToFirst();
                String image_uri = PhotoUtil.getSmallBitmap(uri.getPath(), 360, 480);
    ...
    private void launchProject() {
        ...
        StringRequest launch_project_req = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("details_page", "<html>"+mEditor.getHtml()+"</html>");
