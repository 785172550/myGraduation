				...
				protected void initview() {
								...
								login_btn.setOnClickListener(new View.OnClickListener() {
												...
												public void onClick(View v) {
																// 首先检查是否为空
																if (username_et.getText().toString().isEmpty() || psw_et.getText()
																								.toString()
																								.isEmpty()) {
...
//		});
			...
			login_btn.setClickable(true);
				...
				private void insertIntoDatabase(SuccessResponse<User> successResponse) {
								com.example.model.User user = new com.example.model.User(successResponse.getData()
																.getId(), successResponse.getData().getUsername(),
																successResponse.getData().getPassword(), successResponse.getData()
																.getHeader(), successResponse.getData().getName(),
																successResponse.getData().getSex(), successResponse.getData()
																.getAddress(), successResponse.getData().getContact(),
																successResponse.getData().getService_team(),
																successResponse.getData().getCreate_time(), successResponse.getData()
																.getUpdate_time());
								user.save();
				}
