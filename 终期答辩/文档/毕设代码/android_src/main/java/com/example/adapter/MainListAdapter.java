...
import com.example.util.MainListImageLoader;
...
public class MainListAdapter extends BaseListAdapter {
    ...
    List<Project> data;
    Context context;
	MainListImageLoader mimageLoader;

    public MainListAdapter(Context context, List list) {
        super(context, list);
        this.data = list;
        this.context = context;
		mimageLoader = new MainListImageLoader(context);
    }
    ...
    public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		mimageLoader.displayImage(project.getCover_image(),holder.cover_image,
				R.drawable.ic_default_adimage);
                ...
                StringRequest fav_req = new StringRequest(Request.Method.POST, url,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        return map;
																...
																fav_req.setRetryPolicy(new DefaultRetryPolicy(10000,3,DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
