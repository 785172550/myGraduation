						...
						<div class="two_third last profile_wrapper">
							<div id="profile" class="subcontent">
								<form action="AddCompanyServlet" method="post"  enctype="multipart/form-data">
									<center><h3><b>填写公司信息</b></h3></center>
									<br />
									<br />
									<b>公司名称：</b>
									<input type="text" name="companyname" id="companyname" style="width:267px;height=5px"/>
									<br>
									<br>
									<b>所属行业：</b>
									...
									<br />
									<br />
										<input type="submit" value="添加" style="width:267px;height=5px"/>
									<br>
									<br>
									<br>
