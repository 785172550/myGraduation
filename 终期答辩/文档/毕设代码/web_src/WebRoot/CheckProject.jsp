...
<%@page import="com.sunshine.dao.impl.UserDaoImpl"%>
<%@page import="com.sunshine.dao.UserDao"%>
<%@page import="com.sunshine.entity.User"%>
						...
						<tbody>
							...
							<c:forEach items="${list}" var="u">
								<tr class="gradeX">
									...
									<td>
										<a href="CheckProjectInfoServlet?id=${u.id }&launcher_name=${u.launcher_name }">查看详情</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
